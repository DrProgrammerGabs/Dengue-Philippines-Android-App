...
class PageTreeNodeNew {
    ...
    /* access modifiers changed from: private */
    public final PageNew page;
    private final RectF pageSliceBounds;
    private Rect targetRect;
    private RectF targetRectF;
    private final int treeNodeDepthLevel;

    public PageTreeNodeNew(DocumentViewNew documentView2, RectF localPageSliceBounds, PageNew page2, int treeNodeDepthLevel2, PageTreeNodeNew parent) {
    ...
    public void updateVisibility() {
        ...
        if (this.children != null) {
            for (PageTreeNodeNew child : this.children) {
    ...
    public void invalidateChildren() {
        if (thresholdHit() && this.children == null && isVisible()) {
            ...
            this.children = new PageTreeNodeNew[]{new PageTreeNodeNew(this.documentView, new RectF(0.0f, 0.0f, 0.5f, 0.5f), this.page, newThreshold, this), new PageTreeNodeNew(this.documentView, new RectF(0.5f, 0.0f, 1.0f, 0.5f), this.page, newThreshold, this), new PageTreeNodeNew(this.documentView, new RectF(0.0f, 0.5f, 0.5f, 1.0f), this.page, newThreshold, this), new PageTreeNodeNew(this.documentView, new RectF(0.5f, 0.5f, 1.0f, 1.0f), this.page, newThreshold, this)};
        }
        ...
        if (!isDecodingNow()) {
            ...
            this.documentView.decodeService.decodePage(this, this.page.index, new DecodeCallback() {
                public void decodeComplete(final Bitmap bitmap, final float zoom) {
                    PageTreeNodeNew.this.documentView.post(new Runnable() {
                        public void run() {
                            if (PageTreeNodeNew.this.documentView.zoomModel.getZoom() != zoom) {
                                PageTreeNodeNew.this.setBitmap(null);
                            } else {
                                PageTreeNodeNew.this.setBitmap(bitmap);
                            }
                            PageTreeNodeNew.this.invalidateFlag = false;
                            PageTreeNodeNew.this.setDecodingNow(false);
                            PageTreeNodeNew.this.page.setAspectRatio(PageTreeNodeNew.this.documentView.decodeService.getPageWidth(PageTreeNodeNew.this.page.index), PageTreeNodeNew.this.documentView.decodeService.getPageHeight(PageTreeNodeNew.this.page.index));
                            PageTreeNodeNew.this.invalidateChildren();
                        }
                    });
                }
