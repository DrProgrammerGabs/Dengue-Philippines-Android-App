...
public class ReaderView extends AdapterView<Adapter> implements OnGestureListener, OnScaleGestureListener, Runnable {
    ...
    public void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        if (!this.mUserInteracting && this.mScroller.isFinished()) {
            ...
            cvTop += corr.y;
            cvBottom += corr.y;
        } else if (cv2.getMeasuredHeight() <= getHeight()) {
